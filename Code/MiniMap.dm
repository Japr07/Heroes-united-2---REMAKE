obj/HUD
	MiniMapMarkers
		...
		var/pixy=15
		mouse_opacity=0
		icon='Icons/Other/MiniMapMarkers.dmi'
		New(var/IS)
		...
		Player
			...
			icon_state="Player"
		TW
			icon='Icons/Other/RGBMMFlag.dmi'
		FW
		DB
	MiniMapBG
		icon='Icons/Images/Other/MiniMapEarth.png'
...
mob/proc/ShowForcedMiniMap(var/width=64,var/height=64,var/ImageFile='Icons/Images/Other/FlagWarsMiniMap.png')
...
mob/proc/LoadMiniMapBG()
	...
	for(var/client/C in src.ControlClients)
		...
		var/icon/I
		switch(src.z)
			if(1)	I='Icons/Images/Other/MiniMapEarth.png'
			if(2)	I='Icons/Images/Other/MiniMapOtherWorld.png'
			if(9)	I='Icons/Images/Other/MiniMapHBTC.png'
			if(10)	I='Icons/Images/Other/MineCraftMM.png'
			else	I='Icons/Images/Other/MiniMapNone.png'
