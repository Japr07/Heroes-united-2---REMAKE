...
*/
var/list/beta_testers=list("MaXxiii","aliahmed","scottyg16","Jo-Sword")//Put your ckey here. Your ckey is basically your key without spaces or upper-case letters.
