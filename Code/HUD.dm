obj/HUD
	...
	HudProtection
		...
		icon='Icons/HUD/HudProtection.dmi';icon_state="Color"
		New()
	...
	TextBG
		icon='Icons/Images/HudBG.png'
	HudBarBG
		icon='Icons/Images/HudBarBG.png'
	GuardBar
		layer=11
		mouse_opacity=0
		icon='Icons/HUD/GuardBar.dmi'
	EnemyGuardBar
		layer=11
		mouse_opacity=0
		icon='Icons/HUD/EnemyGuardBar.dmi'
	EnemyGuardBarBG
		icon='Icons/Images/EnemyGuardBarBG.png'
	KiBar
		layer=11
		mouse_opacity=0
		icon='Icons/HUD/KiBars.dmi'
		screen_loc="4:23,17:-2"
	PlBar
		layer=11
		mouse_opacity=0
		icon='Icons/HUD/PlBar1.dmi'
	FaceIcon
		layer=11
		mouse_opacity=0
		icon_state="face"
	...
	ExpBar
		layer=11
		mouse_opacity=0
		icon='Icons/HUD/ExpBar.dmi'
		screen_loc="2:11,17:5"
	AlignmentBar
		layer=11
		mouse_opacity=0
		icon='Icons/HUD/AlignmentBar.dmi'
...
proc/GenerateHudBgList()
	...
	Width=5;HudY=17
	for(var/HudX=1;HudX<=Width;HudX++)
		var/obj/HUD/HudBG/H=new;H.icon='Icons/Images/HudBGR.png'
		H.icon_state="[HudX-1],[HudY-16]";HudBgList+=H
...
mob/proc/KiBlastHUD()
	for(var/client/C in src.ControlClients)
		PlaySound(C.mob,'Sound/Effects/Click.ogg',VolChannel="Menu")
	...
	for(var/client/C in src.ControlClients)
		...
		for(var/i=1;i<=4;i++)
			if(!C.mob.PlBars[i])
				...
				if(i==2 || i==3)	PLB.icon='Icons/HUD/PlBar2.dmi'
				if(i==4)	PLB.icon='Icons/HUD/PlBar3.dmi'
				C.screen+=PLB
				C.mob.PlBars[i]=PLB
